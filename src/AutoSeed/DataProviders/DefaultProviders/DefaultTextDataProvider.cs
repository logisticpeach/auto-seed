...
[assembly:InternalsVisibleTo("AutoSeed.Tests")]

namespace AutoSeed.DataProviders.DefaultProviders
{
    internal class DefaultTextDataProvider : ITextDataProvider
    {
        ...
        public DefaultTextDataProvider()
        {
            try
            {
                ...
                using (var resourceStream = targetAssembly.GetManifestResourceStream("AutoSeed.Resources.text.json"))
                {
